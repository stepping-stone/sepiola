...
function(get_qt_translations_path)
    if (NOT DEFINED QT_TRANSLATIONS_PATH)
        ...
        if (NOT "${_qt_translations_path}")
            message(FATAL_ERROR "Unable to determine Qt's translation path, you have to set QT_TRANSLATIONS_PATH manually")
        endif ()

        set(QT_TRANSLATIONS_PATH ${RUN_OUTPUT}
    ...
    if ("${QT_TRANSLATIONS_PATH}" STREQUAL "")
        message(FATAL_ERROR "Qt translation files are unavailable, please make sure you have the Qt translations package installed")
    endif ()
endfunction()
