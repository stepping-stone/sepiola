...
public:
     ...
     */
    void loadSettings(const QFileInfo &configFile,
                      const QString &resellerAffix = "_reseller",
                      const QString &appDataAffix = "_appData");
    ...
    /**
     * After reinstalling the application, calling this method keeps the user's and application's
     * settings
     */
    void keepSettings();

    /**
     * After reinstalling the application, calling this method resets the user's and application's
     * settings
     */
    void deleteSettings();
...
private slots:
    void setServerUserNameAndPassword(const QString &userName,
                                      const QString &password,
                                      const bool isUsernameEditable);
    void setClientUserNameAndPassword(const QString &userName,
                                      const QString &password,
                                      const bool isUsernameEditable);
