...
#ifndef BACKUP_PROGRESS_DIALOG_HH
#define BACKUP_PROGRESS_DIALOG_HH

#include <QDialog>
#include <QTime>

#include "ui_backup_progress_dialog.h"

/**
 * The OutputDialog class provides a dialog supporting text output
 * @author Bruno Santschi, santschi@puzzle.ch
 */
class BackupProgress : public QDialog, private Ui::BackupProgress
{
	Q_OBJECT
...
public:
	 ...
	 */
	BackupProgress( const QString& title );
