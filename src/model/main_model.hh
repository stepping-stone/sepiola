...
public:
     ...
     */
    void fullRestore(const QString &backup_prefix,
     ...
     * @param destination a destination path for restoring
     */
    void customRestore(const BackupSelectionHash &selectionRules,
...
signals:
    void askForServerPassword(const QString &username,
                              bool isUsernameEditable,
                              int *result = 0,
                              const QString & = "");
    void askForClientPassword(const QString &username,
                              bool isUsernameEditable,
                              int *result = 0,
                              const QString & = "");
