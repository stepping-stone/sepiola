...
QString BackupTask::getStatusText(ConstUtils::StatusEnum status)
{
    if (map_statusText.size() == 0) {
        map_statusText.insert(ConstUtils::STATUS_OK,
                              QObject::tr("<font color=\"green\">Successful</font>"));
        map_statusText.insert(ConstUtils::STATUS_WARNING,
                              QObject::tr("<font color=\"orange\">Warnings</font>"));
        map_statusText.insert(ConstUtils::STATUS_ERROR,
                              QObject::tr("<font color=\"red\">Failed</font>"));
